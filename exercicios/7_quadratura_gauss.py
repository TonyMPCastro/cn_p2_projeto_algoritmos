...
def main():
    ...
    resultado, operacoes = quadratura_gauss(f_torque, a, b, n_pontos, contar_operacoes=True)

    print()
    print("     Cálculo de trabalho do motor (Gauss)")
    print("     Função: f(x) = 5x^3 + x^2 - 12x + 4")
    ...
    print("             Adições/subtrações:", operacoes["adições"])
    print()
